...
export default function PatientDashboard() {
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      {/* Header */}
      <div className="bg-gradient-to-r bg-[#9059a1] py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold text-white mb-2">
            রোগীর ড্যাশবোর্ড
          </h1>
          <p className="text-white opacity-90">
            আবার স্বাগতম, ফাতিমা! এখানে আপনার স্বাস্থ্যের মেট্রিক্স এবং আসন্ন
            অ্যাপয়েন্টমেন্টগুলির একটি সারসংক্ষেপ দেওয়া হল।
          </p>
        </div>
      </div>
              ...
              <div className="space-y-3">
                ...
                <Link href="/patient/consultation" className="block">
                  <Button variant="outline" className="w-full">
                    <Plus className="mr-2 h-4 w-4" /> নতুন অ্যাপয়েন্টমেন্ট বুক
                    করুন
                  </Button>
                </Link>
              </div>
        ...
        <div className="mt-6">
          <Card className="shadow-md">
            <CardHeader>
              ...
              <CardDescription>
                আপনার স্বাস্থ্য তথ্যের AI-চালিত বিশ্লেষণ
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 bg-[#f8BBD0]/10 rounded-lg border border-[#f8BBD0]">
                  ...
                  <p className="text-gray-700">
                    আপনার মাসিক চক্রের ইতিহাসের উপর ভিত্তি করে, আপনার পরবর্তী
                    মাসিক ১০ দিনের মধ্যে শুরু হবে বলে আশা করা হচ্ছে। গত ৩ মাস
                    ধরে আপনার মাসিক চক্র নিয়মিত।
                  </p>
                </div>
                ...
                <div className="p-4 bg-[#f8BBD0]/10 rounded-lg border border-[#f8BBD0]">
                  ...
                  <p className="text-gray-700">
                    আমরা লক্ষ্য করেছি যে আপনার মাসিকের ৩-৪ দিন আগে থেকে আপনার
                    মেজাজ ওঠানামা করে। এই সময়কালে আরামদায়ক কার্যকলাপের
                    সময়সূচী নির্ধারণ করার কথা বিবেচনা করুন।
                  </p>
                </div>
                ...
                <div className="p-4 bg-[#f8BBD0]/10 rounded-lg border border-[#f8BBD0]">
                  ...
                  <p className="text-gray-700">
                    তুমি তোমার দৈনিক জল খাওয়ার লক্ষ্যমাত্রার চেয়ে
                    ধারাবাহিকভাবে কম আছো। তোমার জলীয়তা বৃদ্ধি করলে গত সপ্তাহে
                    তুমি যে মাথাব্যথার কথা বলেছিলে, তা কমাতে সাহায্য করতে পারে।
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6">
                <Link href="/patient/reports">
                  <Button className="w-full bg-[#9059a1] hover:bg-[#683f75]">
                    সম্পূর্ণ স্বাস্থ্য রিপোর্ট দেখুন
                  </Button>
                </Link>
              </div>
            </CardContent>
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow h-full">
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    আপনার লক্ষণগুলি পরীক্ষা করুন এবং সম্ভাব্য স্বাস্থ্যগত
                    উদ্বেগের জন্য সুপারিশ পান।
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow h-full">
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    মানসিক সহায়তা এবং মানসিক স্বাস্থ্যের জন্য আমাদের AI সহকারীর
                    সাথে চ্যাট করুন।
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow h-full">
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    আপনার সঙ্গীর সাথে নিয়ন্ত্রিত পদ্ধতিতে নির্বাচিত স্বাস্থ্য
                    তথ্য শেয়ার করুন।
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow h-full">
              <CardContent className="pt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    অন্যদের সাথে সংযোগ স্থাপন করুন, অভিজ্ঞতা ভাগ করে নিন এবং
                    সম্প্রদায়ের কাছ থেকে পরামর্শ নিন।
                  </p>
                </div>
              </CardContent>
            </Card>
